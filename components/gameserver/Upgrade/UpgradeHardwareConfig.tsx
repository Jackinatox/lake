...
export function UpgradeHardwareConfig({
    ...
    useEffect(() => {
        if (selectedPFGroup?.cpu && selectedPFGroup?.ram) {
            ...
            const upgradeBy: HardwareConfig = {
            ...
            <div className="w-full max-w-7xl mx-auto pb-4 lg:pb-0 flex-1">
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-3 gap-4 lg:gap-6">
                                    ...
                                    <Tabs
                                        ...
                                        onValueChange={(value) => {
                                            ...
                                            if (pfGroup) {
                                                ...
                                                setCpuCores(
                                                    Math.min(cpuCores, pfGroup.cpu.maxThreads),
                                                );
                                            }
                                        }}
                                    >
                                            ...
                                            >
                                                <div className="text-center">
                                                    <div className="flex items-center gap-2 font-medium">
                                                        <span>
                                                            {t('config.duration.three-months')}
                                                        </span>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="px-2">
                                        <Slider
                                            ...
                                            onValueChange={(value) =>
                                                setRamGb(
                                                    Math.max(value[0], initialConfig.ramMb / 1024),
                                                )
                                            }
                                            className="w-full"
                                        />
                    ...
                    <div className="order-1 lg:order-2">
                        <div className="sticky top-0 z-10 bg-card shadow-md lg:shadow-none lg:top-4">
                                        ...
                                        <Table>
                                            <TableHeader>
                                                <TableRow>
                                                    <TableCell></TableCell>
                                                    <TableCell>
                                                        {t('pricing.headers.vcpu')}
                                                    </TableCell>
                                                    <TableCell>
                                                        {t('pricing.headers.ram')}
                                                    </TableCell>
                                                </TableRow>
                                            </TableHeader>
                                            <TableBody>
