        ...
        <div className="w-full max-w-7xl mx-auto">
            ...
            <Card className="mb-6 shadow border border-primary/30">
                <CardHeader>
                    ...
                    <CardDescription className="text-sm">{t('info.description')}</CardDescription>
                </CardHeader>
            </Card>
                                    ...
                                    <Table>
                                        ...
                                        <TableBody>
                                            <TableRow>
                                                ...
                                                <TableCell>
                                                    {(totalPrice.upgradeCents.cpu / 100).toFixed(2)}{' '}
                                                    €
                                                </TableCell>
                                                <TableCell>
                                                    {(totalPrice.upgradeCents.ram / 100).toFixed(2)}{' '}
                                                    €
                                                </TableCell>
                                            </TableRow>
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell>
                                                    {(totalPrice.extendCents.cpu / 100).toFixed(2)}{' '}
                                                    €
                                                </TableCell>
                                                <TableCell>
                                                    {(totalPrice.extendCents.ram / 100).toFixed(2)}{' '}
                                                    €
                                                </TableCell>
                                            </TableRow>
                                        </TableBody>
