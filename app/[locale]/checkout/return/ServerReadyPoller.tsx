    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center bg-gradient-to-b from-background via-background to-muted/70 px-4 py-16">
            ...
            <div className="relative z-10 w-full max-w-3xl space-y-8">
                <div
                    className={`rounded-3xl border ${cardBorderClass} bg-card/80 p-8 shadow-2xl backdrop-blur-md md:p-10`}
                >
                    <div className="flex flex-col items-center gap-6 text-center">
                        <span
                            className={`relative flex h-16 w-16 items-center justify-center rounded-full ${iconContainerClass}`}
                        >
                            {showLoader ? (
                        ...
                        <div className="space-y-2">
                            <h1
                                className={`text-2xl font-semibold tracking-tight md:text-3xl ${mainTitleClass}`}
                            >
                                {mainTitle}
                            </h1>
                        ...
                        <div className="space-y-2">
                            <h2 className={`text-xl font-semibold md:text-2xl ${statusToneClass}`}>
                                {headline}
                            </h2>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="space-y-1">
                                        <p className="font-semibold text-destructive">
                                            {networkError
                                                ? pollerT('networkBannerTitle')
                                                : pollerT('errorBannerTitle')}
                                        </p>
