    ...
    return (
        ...
        >
            ...
            <Text style={textStyle}>
                Wir bestätigen, dass das Passwort deines Scyed Kontos gerade geändert wurde. Du kannst
                dich ab sofort mit deinem neuen Passwort anmelden.
            </Text>
            ...
            <Text style={{ ...textStyle, marginTop: 16 }}>
                ...
                Support-Team. Wir empfehlen zusätzlich die Aktivierung der Zwei-Faktor-Authentifizierung.
            </Text>
