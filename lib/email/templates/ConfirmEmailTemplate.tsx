                ...
                <Body style={{ backgroundColor: '#f8f9fa', margin: 0, padding: 0 }}>
                    <Container style={{ margin: '0 auto', maxWidth: '520px', backgroundColor: '#ffffff', padding: '32px 24px' }}>
                        ...
                        <Text className="mt-4 text-base leading-6 text-slate-600">
                            Willkommen bei Scyed! Um dein Konto zu aktivieren und alle Funktionen nutzen zu können, bestätige bitte deine E-Mail-Adresse.
                        </Text>
                        ...
                        <Text className="mt-2 break-all text-sm leading-6 text-slate-500">{url}</Text>
                        <Text className="mt-6 text-base leading-6 text-slate-600">
                        ...
                        <Text className="mt-8 text-sm leading-6 text-slate-400">
                            Du erhältst diese E-Mail, weil eine Registrierung mit dieser E-Mail-Adresse bei Scyed durchgeführt wurde.
                        </Text>
                    </Container>
                </Body>
            </Tailwind>
