        ...
        <>
            {supportText ? (
                <Text className="mt-6 text-base leading-6 text-slate-600">
                    Bei Fragen oder wenn du Unterstützung brauchst, melde dich jederzeit bei unserem{' '}
                    <a
            ...
            <Text className="mt-8 text-sm leading-6 text-slate-400">
                Du erhältst diese E-Mail, weil du ein Konto bei Scyed hast. Wenn du keine Emails
                mehr bekommen möchtest, lösche dein Konto, indem du dich bei unserem{' '}
                <a
                    href={`${APP_URL}/support`}
