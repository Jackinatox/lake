/*
  ...
  - Made the column `gameDataId` on table `ServerIntend` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_ServerIntend" ("cpuId", "cpuPercent", "gameConfig", "gameDataId", "id", "ramId", "ramMB", "userId") SELECT "cpuId", "cpuPercent", "gameConfig", "gameDataId", "id", "ramId", "ramMB", "userId" FROM "ServerIntend";
